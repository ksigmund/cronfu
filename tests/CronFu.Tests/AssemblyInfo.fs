...
[<assembly: AssemblyTitleAttribute("CronFu.Tests")>]
[<assembly: AssemblyProductAttribute("CronFu")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "CronFu.Tests"
    let [<Literal>] AssemblyProduct = "CronFu"
